...
// Moving background
path=createSprite(displayWidth/2,displayHeight/2-100);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distance: "+ distance,displayWidth/2 +300,30);
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    fill("white");
    text("Press Up Arrow Key to Restart the game",displayWidth/3 ,displayHeight/2-50)
